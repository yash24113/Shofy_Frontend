...
export default function UserProfile() {
  ...
  const handleCancel = () => {
    // reset to last known values and exit edit mode
    reset(getValues()); // keeps current form values
    setEditing(false);
  };
  ...
  return (
    <div className="profile-container">
      ...
      <div className="profile-card glassmorphism">
        ...
        {/* Inline section: either details grid OR edit form */}
        {!isEditing ? (
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="profile-form-inline">
            ...
            {/* Inline actions (duplicated on top for convenience already, but keep in form for submit via Enter) */}
      ...
      <style jsx>{`
        ...
        .edit-button, .logout-button, .save-button.inline, .cancel-button.subtle {
          display: flex;
          align-items: center;
          gap: 0.5rem;
...
function FormField({ id, label, type, placeholder, register, error, disabled, note, required }) {
  return (
    <div className="form-field">
      ...
      <style jsx>{`
        .form-field { margin-bottom: 0.5rem; position: relative; }
        .field-label {
          display: block;
        ...
        .required-star { color: #f44336; margin-left: 0.25rem; }
        .field-input {
          width: 100%;
          padding: 1rem;
          border: 1px solid #e0e0e0;
        ...
        .field-note { margin: 0.4rem 0 0; font-size: 0.8125rem; color: #888; }
        .field-error { margin: 0.35rem 0 0; font-size: 0.8125rem; color: #f44336; }
      `}</style>
    </div>
  );
}
...
function IconPhone(){return(
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M22 16.92V19.92C22 20.47 21.55 20.92 21 20.92H19C18.45 20.92 18 20.47 18 19.92V16.92C18 16.37 18.45 15.92 19 15.92H21C21.55 15.92 22 16.37 22 16.92Z" fill="currentColor"/><path d="M10.02 4.47L12 2M12 2L13.99 4.47M4.91 7.8C3.8 9.28 3 11.06 3 13" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
)}
function IconAddress(){return(
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M21 10C21 17 12 23 12 23C12 23 3 17 3 10C3 7.61 3.95 5.32 5.64 3.64C7.32 1.95 9.61 1 12 1C14.39 1 16.68 1.95 18.36 3.64C20.05 5.32 21 7.61 21 10Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><path d="M12 13C13.66 13 15 11.66 15 10C15 8.34 13.66 7 12 7C10.34 7 9 8.34 9 10C9 11.66 10.34 13 12 13Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
)}
function IconPin(){return(
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M12 2C8.13 2 5 5.13 5 9C5 14.25 12 22 12 22C12 22 19 14.25 19 9C19 5.13 15.87 2 12 2Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><path d="M12 11C13.1 11 14 10.1 14 9C14 7.9 13.1 7 12 7C10.9 7 10 7.9 10 9C10 10.1 10.9 11 12 11Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
)}
function IconGlobe(){return(
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M12 22C17.523 22 22 17.523 22 12C22 6.477 17.523 2 12 2C6.477 2 2 6.477 2 12C2 17.523 6.477 22 12 22Z" stroke="currentColor" strokeWidth="1.5"/><path d="M8 3H9C7.05 8.84 7.05 15.16 9 21H8" stroke="currentColor" strokeWidth="1.5"/><path d="M15 3C16.95 8.84 16.95 15.16 15 21" stroke="currentColor" strokeWidth="1.5"/><path d="M3 16V15C8.84 16.95 15.16 16.95 21 15V16" stroke="currentColor" strokeWidth="1.5"/><path d="M3 9C8.84 7.05 15.16 7.05 21 9" stroke="currentColor" strokeWidth="1.5"/></svg>
)}
function IconGlobe2(){return(
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M12 22C17.523 22 22 17.523 22 12C22 6.477 17.523 2 12 2C6.477 2 2 6.477 2 12C2 17.523 6.477 22 12 22Z" stroke="currentColor" strokeWidth="1.5"/><path d="M8 3H9C7.05 8.84 7.05 15.16 9 21H8" stroke="currentColor" strokeWidth="1.5"/><path d="M15 3C16.95 8.84 16.95 15.16 15 21" stroke="currentColor" strokeWidth="1.5"/><path d="M3 16V15C8.84 16.95 15.16 16.95 21 15V16" stroke="currentColor" strokeWidth="1.5"/><path d="M3 9C8.84 7.05 15.16 7.05 21 9" stroke="currentColor" strokeWidth="1.5"/></svg>
)}
function IconClockSmall(){return(
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M12 22C17.523 22 22 17.523 22 12C22 6.477 17.523 2 12 2C6.477 2 2 6.477 2 12C2 17.523 6.477 22 12 22Z" stroke="currentColor" strokeWidth="1.5"/><path d="M12 8V12L15 15" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
)}
function IconCalendar(){return(
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M19 4H5C3.895 4 3 4.895 3 6V20C3 21.105 3.895 22 5 22H19C20.105 22 21 21.105 21 20V6C21 4.895 20.105 4 19 4Z" stroke="currentColor" strokeWidth="1.5"/><path d="M16 2V6" stroke="currentColor" strokeWidth="1.5"/><path d="M8 2V6" stroke="currentColor" strokeWidth="1.5"/><path d="M3 10H21" stroke="currentColor" strokeWidth="1.5"/></svg>
)}
function IconClock(){return(
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M12 22C17.523 22 22 17.523 22 12C22 6.477 17.523 2 12 2C6.477 2 2 6.477 2 12C2 17.523 6.477 22 12 22Z" stroke="currentColor" strokeWidth="1.5"/><path d="M12 6V12L16 14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
)}
